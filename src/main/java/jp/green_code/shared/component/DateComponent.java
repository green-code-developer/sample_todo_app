...
public class DateComponent {
    ...
    public static final OffsetDateTime BLANK_OFFSET_TIME = parseISO("1900-01-01T00:00:00+00:00").orElseThrow();

    private final ZoneId zoneId;

    public DateComponent(ZoneId zoneId) {
        this.zoneId = zoneId;
    }
    ...
    public OffsetDateTime toOffsetDateTime(LocalDate ld) {
    ...
    public OffsetDateTime localDateToOffsetDateTime(LocalDate ld) {
