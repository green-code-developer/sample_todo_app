...
import static jp.green_code.todo.todo.util.AppNotification.errorNotification;
import static jp.green_code.todo.todo.util.AppNotification.successNotification;
...
public class TodoController {
    ...
    public ModelAndView list(
        ...
        // 検索結果取得
        var list = todoService.findByForm(form);
    ...
    public String newTodoPost(
        ...
        if (!result.getLeft().isSuccess()) {
            ...
            redirectAttributes.addFlashAttribute(AppNotification.NOTIFICATION, AppNotification.errorNotification(VALIDATION_ERROR_MESSAGE_KEY));
        ...
        var messageKey = result.getRight() ? "notification.complete-post" : "notification.complete-update";
        redirectAttributes.addFlashAttribute(AppNotification.NOTIFICATION, AppNotification.successNotification(messageKey));
