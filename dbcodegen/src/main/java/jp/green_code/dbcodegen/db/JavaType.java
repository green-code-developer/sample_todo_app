...
public record JavaType(
        ...
        String fqcn,
        /* entityToParam() で値を加工するコード。省略時は entity.%s() (%sはgetter) */
    ...
    public JavaType(String fqcn, String dbParamTemplate) {
        this(fqcn, "entity.%s() + \"\"", dbParamTemplate, null, "return pickBySeed(%s.class, seed);".formatted(fqcn), null);
    }

    // 文字列
    public static final JavaType STRING = new JavaType("java.lang.String", null, null, null, "return seed + \"\";", "assertEquals(expected, value.trim());");
    ...
    public static final JavaType XML = new JavaType("java.lang.String", null, ":%s::xml", null, "return \"<xml>%s</xml>\".formatted(seed);", null);
    public static final JavaType JSON = new JavaType("java.lang.String", "entity.%s() + \"\"", ":%s::jsonb", null, "return \"{\\\"id\\\": %d}\".formatted(seed);", null);
    ...
    public static final JavaType DURATION = new JavaType("java.lang.Long", null, "make_interval(secs => :%s)", "extract(epoch FROM {colName}) AS {colName}", "return (long) seed;", null);

    // ネットワーク
    public static final JavaType INET = new JavaType("java.lang.String", null, ":%s::inet", null, "return String.format(\"%d.%d.%d.%d\", (seed >> 24) & 0xFF, (seed >> 16) & 0xFF, (seed >> 8) & 0xFF, seed & 0xFF);", null);
    public static final JavaType CIDR = new JavaType("java.lang.String", null, ":%s::cidr", null, "return String.format(\"%d.%d.%d.%d/32\", (seed >> 24) & 0xFF, (seed >> 16) & 0xFF, (seed >> 8) & 0xFF, seed & 0xFF);", null);
    public static final JavaType MACADDR = new JavaType("java.lang.String", null, ":%s::macaddr", null, "return String.format(\"00:00:%02x:%02x:%02x:%02x\", (seed >> 24) & 0xFF, (seed >> 16) & 0xFF, (seed >> 8) & 0xFF, seed & 0xFF);", null);

    // 幾何
    public static final JavaType POINT = new JavaType("java.lang.String", null, ":%s::point", "{colName}::text", "return \"(0,%d)\".formatted(seed);", null);
    public static final JavaType LINE = new JavaType("java.lang.String", null, ":%s::line", "{colName}::text", "return \"{1,-1,%d}\".formatted(seed);", null);
    public static final JavaType BOX = new JavaType("java.lang.String", null, ":%s::box", "{colName}::text", "return \"(1,%d),(0,0)\".formatted(seed);", null);
    public static final JavaType LSEG = new JavaType("java.lang.String", null, ":%s::lseg", "{colName}::text", "return \"[(1,%d),(0,0)]\".formatted(seed);", null);
    public static final JavaType PATH = new JavaType("java.lang.String", null, ":%s::path", "{colName}::text", "return \"((2,%d),(1,1),(0,0))\".formatted(seed);", null);
    public static final JavaType POLYGON = new JavaType("java.lang.String", null, ":%s::polygon", "{colName}::text", "return \"((2,%d),(1,1),(0,0))\".formatted(seed);", null);
    public static final JavaType CIRCLE = new JavaType("java.lang.String", null, ":%s::circle", "{colName}::text", "return \"<(0,0),%d>\".formatted(seed);", null);
